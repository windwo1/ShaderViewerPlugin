...
{
    public class ShaderDataPermutation
    {
        ...
        public ShaderDataPermutation()
        {
        }

        public ShaderDataPermutation(NativeReader reader, string pathName)
        {
            // shader GUID
    ...
    public class VertexShaderPermutation : ShaderDataPermutation
    {
    ...
    public class PixelShaderPermutation : ShaderDataPermutation
    {
    ...
    public class HullShaderPermutation : ShaderDataPermutation
    {
    ...
    public class DomainShaderPermutation : ShaderDataPermutation
    {
    ...
    public class BFVUnkShaderPermutation : ShaderDataPermutation
    {
    ...
    public class BFVUnkShaderPermutation1 : ShaderDataPermutation
    {
