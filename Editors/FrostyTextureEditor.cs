...
namespace MeshSetPlugin.Editors
{
    ...
    public class FrostyTextureEditor : FrostyTypeEditor<FrostyTextureControl>
    {
        public FrostyTextureEditor()
        {
            ValueProperty = FrostyTextureControl.ResultProperty;
        }
    }
    ...
    public class FrostyTextureControl : Control
    {
        ...
        #region -- Result --
        public static readonly DependencyProperty ResultProperty = DependencyProperty.Register("Result", typeof(string), typeof(FrostyTextureControl), new FrameworkPropertyMetadata(""));
        ...
        #region -- SelectedItem --
        public static readonly DependencyProperty SelectedItemProperty = DependencyProperty.Register("SelectedItem", typeof(EbxAssetEntry), typeof(FrostyTextureControl), new FrameworkPropertyMetadata(null));
        ...
        static FrostyTextureControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(FrostyTextureControl), new FrameworkPropertyMetadata(typeof(FrostyTextureControl)));
        }
        ...
        private void Popup_DropDownOpened(object sender, EventArgs e)
        {
            ...
            dataExplorer.ItemsSource = App.AssetManager.EnumerateEbx(type: "TextureAsset");
