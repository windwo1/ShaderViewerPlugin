...
namespace MeshSetPlugin
{
    ...
    public class MeshOptions : OptionsExtension
    {
        ...
        [Description("The texture used for the skybox.")]
        [Editor(typeof(FrostyTextureEditor))]
        ...
        public override void Load()
        {
            ...
            SkyboxTexture = Config.Get<string>("SkyboxTexture", "", ConfigScope.Game);
            ...
            RenderShadersEnabled = Config.Get<bool>("RenderShadersEnabled", true);
        ...
        public override void Save()
        {
            ...
            Config.Add("SkyboxTexture", SkyboxTexture, ConfigScope.Game);
            ...
            Config.Add("RenderShadersEnabled", RenderShadersEnabled);
